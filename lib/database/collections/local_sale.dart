...
// (`local_sale_io.dart`), con esquema offline-first persistente.
//
// En web (`dart.library.html`) usa un modelo plano sin Isar
// (`local_sale_web.dart`): la persistencia offline queda DEGRADADA en web
...
export 'local_sale_io.dart'
    if (dart.library.html) 'local_sale_web.dart';

...
// (`local_table_tab_io.dart`), con esquema offline-first persistente.
//
// En web (`dart.library.html`) usa un modelo plano sin Isar
// (`local_table_tab_web.dart`): la persistencia offline queda DEGRADADA en web
...
export 'local_table_tab_io.dart'
    if (dart.library.html) 'local_table_tab_web.dart';
